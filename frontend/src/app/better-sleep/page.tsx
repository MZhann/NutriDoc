...
const BetterSleepPage = () => {
  ...
  return (
    <div className="w-full flex bg-[#03174C] flex-col items-center">
      <div className="bg-[#03174C] w-full max-w-4xl  min-h-screen flex flex-col text-white">
          ...
          <div className="w-full flex gap-3 mt-2">
            ...
            >
              ...
              <p className="text-white text-lg mt-2">
                Never Tell -{" "}
                <span className="text-sm text-[#98A1BD]">Luke</span>
              </p>
            ...
            >
              ...
              <p className="text-white text-lg mt-2">
                Sleep lofi -{" "}
                <span className="text-sm text-[#98A1BD]">Sleep</span>
              </p>
